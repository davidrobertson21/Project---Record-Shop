...
class Album
  ...
  def save()
    sql = "INSERT INTO albums ( title, artist_id, genre_id, quantity, buy_price, album_artwork, quantity, buy_price, album_artwork ) VALUES ('#{ @title }',#{ @artist_id },#{ @genre_id },#{ @quantity }, #{ @buy_price }, '#{album_artwork}') 
      RETURNING *;"
