...
class Album
  ...
  attr_reader :id, :title, :artist_id, :album_id, :quantity, :buy_price, :album_artwork
  ...
  def save()
    sql = "INSERT INTO albums ( title, artist_id, album_id, quantity, buy_price, album_artwork, quantity, buy_price, album_artwork ) VALUES ('#{ @title }',#{ @artist_id },#{ @album_id },#{ @quantity }, #{ @buy_price }, '#{album_artwork}') 
      RETURNING *;"
